...
public class CPU_3_3_3_Notice extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cpu_2_3_3_notice);	
		pageco=1;
		Intent intent = getIntent();
		s_doctor_id = intent.getStringExtra("doctor_id");	
		s_doctor_pw = intent.getStringExtra("doctor_pw");
		urlPath="http://220.67.113.124/CPU/mobile/listnotice.php";
	...
	private void setList(){
		...
		adapter = new List_Adapter(CPU_3_3_3_Notice.this, m_arr,CPU_3_3_3_Notice.this);
	...
	public void parse(String urlPath){
		...
		try{
			...
			{
				urlPath2="http://220.67.113.124/CPU/mobile/view.php?t=notice&num="+number[i];
				...
				record = result2.substring(pt_start+1, pt_end);
