...
public class CPU_3_2_2_Edit_Data_Social extends Activity {
	...
	public class DownloadWebpageTask extends AsyncTask<String, Void, String> {
		...
		public void onPostExecute(String result) {
			...
			int pt_end=-1;
			int i;
			String tag_start[] = {"id=","name=","medical_num=","social_num=","product_num=","re1=","re2=","address=","medicine=","medical_history=","special="};
			String tag_end[] = {"=id","=name","=medical_num","=social_num","=product_num","=re1","=re2","=address","=medicine","=medical_history","=special"};
			...
			for(i=0; i<10; i++) {
				...
				if(pt_start != -1) {
					...
					if(pt_end != -1) {
						...
						if(i==6) t_emergency_num2.setText(word);
						if(i==7) t_address.setText(word);
						if(i==8) t_medicine.setText(word);
						if(i==9) t_medical_history.setText(word);
						if(i==10) t_special.setText(word);
					} else
	...
	public void edit_save(View v) throws Exception{		
		...
		String strUrl = "http://220.67.113.124/CPU/mobile/insert.php?userid="+URLEncoder.encode(s_user_id,"UTF-8")
	...
	public void mypage(View v){		
		Vibrator vibe_add = (Vibrator)getSystemService(Context.VIBRATOR_SERVICE);
		vibe_add.vibrate(50);		
		Intent mypage = new Intent(this, CPU_3_2_2_Edit_Data_Social.class);
