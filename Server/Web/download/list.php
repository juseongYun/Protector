...
?>
			<div id="page_button">
				<div id="page_num"><?$prepage=$page-1; if($page!=1)print"<a href='list.php?table=download&page=$prepage'> ◀ 이전 &nbsp;&nbsp;&nbsp;&nbsp;</a>";
        else print"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";?>
<?
   ...
   for ($i=1; $i<=$total_page; $i++)
   {
		...
		$nextpage=$page+1;
    if($page!=$total_page)
	print"<a href='list.php?table=download&page=$nextpage'>	&nbsp;&nbsp;&nbsp;&nbsp;다음 ▶</a>"
  ?>
				</div>
				<div id="button">
