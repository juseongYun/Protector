<? 
	...
	if ($mode=="modify")
	{
		...
		$item_file_0 = $row[file_name];

		$copied_file_0 = $row[file_copied];
	}
//get unique id
$up_id = uniqid(); 
?>
  ...
  function check_input()
   {
      ...
      if (!document.board_form.isfile.value)
      {
         alert("이미지를 선택하세요!");
         return;
      }
...
{
	$userid=$_SESSION['pid'];$username=$_SESSION['pname'];
}
else{
...
?>
      ...
      <div class="col2"><?=$username." ( ".$userid." )"?></div></div>
...
<div id="preview"><div class="col1"> 미리보기   </div>
 <div class="col2" style="line-height:300px; align = "center""><img id="blah" src="data/<?=$copied_file_0?>" onerror="this.src='../img/select.jpg'" width=350px  align = "middle""/ ></div>
</div>
...
<div class="write_line"></div>
	...
	<!--APC hidden field-->
	        ...
	        <input type="hidden" name ="isfile" id = "isfile" value=<?=$copied_file_0?>
